...
CREATE FUNCTION pg_xlog_replay_pause_on_restore_point(text) RETURNS void LANGUAGE internal VOLATILE STRICT PARALLEL SAFE AS 'pg_xlog_replay_pause_on_restore_point' WITH (OID=7144, DESCRIPTION="pause WAL replay on user-provided restore point");
