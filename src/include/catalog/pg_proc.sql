...
CREATE FUNCTION gp_switch_xlog() RETURNS SETOF record LANGUAGE internal VOLATILE STRICT AS 'gp_switch_xlog' WITH (OID=6999,  DESCRIPTION="Switch xlog files on all segments");
